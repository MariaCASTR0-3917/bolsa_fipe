...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 130 }, { marker: 'pandoc', elapsed: 140 }, { marker: 'post-processor', elapsed: 60 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 1180 } ];
